...
root_dir = Path("Dirctory Path") <-- Change this to your desired root directory
output_file = root_dir / "Combined_Workbook_with_Index.xlsx" <-- Change this to your desired target file name
